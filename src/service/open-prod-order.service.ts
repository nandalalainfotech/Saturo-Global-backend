...
import { Openprodorder001mb } from 'src/entity/Openprodorder001mb';
var html = fs.readFileSync("open-order.html", "utf8");


@Injectable()
export class OpenProdOrderService {
    constructor(@InjectRepository(Openprodorder001mb) private readonly openProdOrderRepository: Repository<Openprodorder001mb>) { }

    async create(openprodorderDTO: OpenprodorderDTO): Promise<Openprodorder001mb> {
    ...
    async update(openprodorderDTO: OpenprodorderDTO): Promise<Openprodorder001mb> {
        const openprodorder001mb = new Openprodorder001mb();
        openprodorder001mb.setProperties(openprodorderDTO);
        await this.openProdOrderRepository.update({ prodId: openprodorder001mb.prodId }, openprodorder001mb);
