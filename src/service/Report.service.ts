    ...
    async downloadExcel(@Req() request: Request, @Res() response: Response) {
        ...
        if ((ligand.length < 0) && (assay.length < 0) && (measurement.length < 0)) {
            ...
            for (let i = 0; i < ligand.length; i++) {
                ...
                worksheet.getCell('G' + temp).value = ligand[i].identifier1;
                ...
                worksheet.getCell('H' + temp).value = ligand[i].identifier2;
                ...
                worksheet.getCell('I' + temp).value = ligand[i].identifier3;
                ...
                worksheet.getCell('J' + temp).value = ligand[i].collectionId;
                ...
                worksheet.getCell('K' + temp).value = ligand[i].ligandDetail;
                ...
                worksheet.getCell('L' + temp).value = ligand[i].locator;
                ...
                worksheet.getCell('M' + temp).value = ligand[i].sourceType;
                ...
                worksheet.getCell('N' + temp).value = ligand[i].citation;
                ...
                worksheet.getCell('O' + temp).value = ligand[i].citation;
                ...
                worksheet.getCell('P' + temp).value = ligand[i].collectionId;
                ...
                worksheet.getCell('BK' + temp).value = ligand[i].target;
                ...
                worksheet.getCell('BL' + temp).value = ligand[i].targetVersion;
                ...
                worksheet.getCell('BM' + temp).value = ligand[i].targetStatus;
                ...
                worksheet.getCell('BN' + temp).value = ligand[i].collectionId1;
                ...
                worksheet.getCell('BO' + temp).value = ligand[i].original;
                ...
                worksheet.getCell('BP' + temp).value = ligand[i].acronym;
                ...
                worksheet.getCell('BQ' + temp).value = ligand[i].organism;
                ...
                worksheet.getCell('BR' + temp).value = ligand[i].variant;
            ...
            for (let i = 0; i < assay.length; i++) {
                ...
                worksheet.getCell('Q' + temp).value = assay[i].ordinal;
                ...
                worksheet.getCell('R' + temp).value = assay[i].collectionId;
                ...
                worksheet.getCell('S' + temp).value = assay[i].assayTypeSlno2.assayType;
                ...
                worksheet.getCell('T' + temp).value = assay[i].toxiCitySlno2.toxiCity;
                ...
                worksheet.getCell('U' + temp).value = assay[i].routeSlno2.route;
